...
#' 
#' @description \code{sample_fSAN_sparsemix} is used to perform posterior inference under the finite shared atoms nested (fSAN) model with Gaussian likelihood. 
...
#' out <- sample_fSAN_sparsemix(nrep = 3000, y = y, group = g, 
#'                              alpha = 0.01, beta = 0.01)
#' out 
#' }
#' 
#' @references Malsiner-Walli, G., Frühwirth-Schnatter, S. and Grün, B. (2016). 
                          ...
                          seed = NULL)
{
  ...
  start = Sys.time()
  out = sample_overcam_arma(nrep, y, group, 
                            maxK, maxL, 
                            m0, tau0, 
                            lambda0, gamma0,
